...
const validationSchema = Yup.object({
  ...
  terms_conditions_accepted: Yup.boolean()
              ...
              <div className="space-y-5">
                ...
                <div>
                  <div className="relative">
                    ...
                    <span
                      ...
                      className="absolute z-30 -translate-y-1/2 cursor-pointer right-4 top-1/2 mt-3"
                    >
                      {showPassword ? (
                ...
                <div className="flex items-center gap-3">
                  <Checkbox
                    ...
                    setFieldError={(field) => setFieldError(field, undefined)}
                    onChange={(value) => {
                      setFieldValue("terms_conditions_accepted", value);
                    }}
                  />
                </div>
